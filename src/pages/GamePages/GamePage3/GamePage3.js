...
const GamePage3 = () => {
    ...
    const [optionA, setOptionA] = useState(
       ...
       const [body,setBody] = useState(
        {title:"",
         text:"You decide to go back to the club to see if someone's returned your wallet or if you can find where its been dropped - but the bouncer wont let you in because you have no ID, but you have no ID bc you have no wallet!"
        })
  ...
  return (
    <div className='body__block--character gamePage3'>
     ...
     <div className='gamePage3__options'>
          ...
          <Link className='gamePage3__optionA' >
            <OptionAButton optionA={optionA}/>
          </Link>
    
          <Link  className='gamePage3__optionB'>
            <OptionBButton optionB={optionB}/> 
          </Link>
  
      </div>
      <div className='gamePage3__character'>
        <img className='gamePage3__character--right fadeIn' alt='bestie' src={friendv3}/> 
        <img className='gamePage3__character--left fadeIn' alt='gameplayer' src={placeholder}/>
      </div>
    </div>
  )
}
